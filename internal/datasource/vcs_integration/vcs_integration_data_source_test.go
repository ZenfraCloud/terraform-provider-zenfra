// ABOUTME: Unit tests for the singular VCS integration data source model mapping.
// ABOUTME: Verifies correct conversion for GitHub, GitLab, and pending integrations.
...
func TestMapVCSIntegrationToDataSource(t *testing.T) {
	tests := []struct {
		name     string
		input    *zenfraclient.VCSIntegration
		expected vcsIntegrationDataSourceModel
	}{
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := mapVCSIntegrationToDataSource(tt.input)
